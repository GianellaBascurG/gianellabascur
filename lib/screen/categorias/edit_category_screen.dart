...
import 'package:bascur_gianella/providers/category_form_provider.dart';
...
class _CategoryScreenBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Editar/Crear categoria'),
      ),
...
class _CategoryForm extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    bool switchValue = category.categoryState == "Activa";
              ...
              SwitchListTile.adaptive(
                ...
                onChanged: (value) {
                  ...
                  category.categoryState =
                      value == true ? "Activa" : "bloqueada";
                },
                activeColor: Color.fromARGB(255, 79, 150, 216),
